...
optimizer1 = optim.SGD(net1.parameters(), lr=0.001, momentum=0.9, weight_decay=5e-4)
optimizer2 = optim.Adadelta(net2.parameters(), weight_decay=5e-4)
optimizer3 = optim.Adam(net3.parameters(), lr=0.001, weight_decay=5e-4)
...
def plot_metrics():
    ...
    plt.tight_layout()
    plt.show()
    plt.savefig('plots/S_A_A_train_metrics.png')
